...
namespace QUANLYNHAHANG.Controllers
{
    public class DonhangsController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.M?_TT = new SelectList(db.Trangthaidonhangs, "M?_TT", "Tr?ng_thái");
            return View();
        }
        ...
        public ActionResult Create(Donhang donhang)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                donhang.M?_ÐH = Guid.NewGuid().ToString();
            ...
            GetShoppingCart();
            ViewBag.Cart = ShoppingCart;
            ViewBag.M?_TT = new SelectList(db.Trangthaidonhangs, "M?_TT", "Tr?ng_thái", donhang.M?_TT);
            return View(donhang);
        }
        private void ValidateDonhang(Donhang donhang)
        {
            ...
            if (ShoppingCart.Count == 0)
                ModelState.AddModelError("", "Không có s?n ph?m nào trong gi? hàng!");
            if (!regex.IsMatch(donhang.SÐT))
                ModelState.AddModelError("SÐT", "Sai s? ði?n tho?i");
        }
